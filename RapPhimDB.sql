...
--insert tblFilm
insert tblFilm (FilmID,Name,Language,Director,ProductionDate,Price) values (N'PB',N'Peaky Blinders',N'Tiếng Anh',N'Steven Knight','9-12-2013',50000)
insert tblFilm (FilmID,Name,Language,Director,ProductionDate,Price) values (N'CC',N'CoCo',N'Tiếng Anh',N'Lee Unkrich','10-20-2017',70000)
insert tblFilm (FilmID,Name,Language,Director,ProductionDate,Price) values (N'MDD',N'Mộ Đom Đóm',N'Tiếng Nhật',N'Takahata Isao','4-16-1988',70000)
insert tblFilm (FilmID,Name,Language,Director,ProductionDate,Price) values (N'BWY',N'Be With You',N'Tiếng Hàn',N'Lee Jang-hoon','3-14-2018',70000)
insert tblFilm (FilmID,Name,Language,Director,ProductionDate,Price) values (N'NBN',N'Nhà Bà Nữ',N'Tiếng Việt',N'Trấn Thành','1-11-2023',80000)
insert tblFilm (FilmID,Name,Language,Director,ProductionDate,Price) values (N'EVT',N'Em Và Trịnh',N'Tiếng Việt',N'Phan Gia Nhật Linh','6-10-2022',70000)
--insert Showtime
